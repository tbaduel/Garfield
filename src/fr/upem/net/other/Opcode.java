...
public enum Opcode {
	ERROR(-1), LOGIN(0), SIGNUP(1), MESSAGE(2), REQUEST(3), WHISP(7), FILE_REQUEST(4), FILE_SEND(6), FILE_OK(5), IPRESPONSE(98), MESSAGEBROADCAST(99), 
	...
	CHECK_PRIVATE(111), CHECK_FILE(112)		
